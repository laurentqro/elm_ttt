...
var author$project$Main$GameStateReceived = function (a) {
	return {$: 'GameStateReceived', a: a};
};
var author$project$Main$Model = F5(
	function (player_x, player_o, game_state, current_player, board) {
		return {board: board, current_player: current_player, game_state: game_state, player_o: player_o, player_x: player_x};
	});
var author$project$Main$Player = F2(
	function (tipe, mark) {
		return {mark: mark, tipe: tipe};
	});
...
var author$project$Main$playerDecoder = A3(
	...
	A2(elm$json$Json$Decode$field, 'mark', elm$json$Json$Decode$string));
var elm$json$Json$Decode$list = _Json_decodeList;
var elm$json$Json$Decode$map5 = _Json_map5;
var author$project$Main$gameDecoder = A6(
	elm$json$Json$Decode$map5,
	author$project$Main$Model,
	A2(elm$json$Json$Decode$field, 'player_x', author$project$Main$playerDecoder),
	A2(elm$json$Json$Decode$field, 'player_o', author$project$Main$playerDecoder),
	A2(elm$json$Json$Decode$field, 'game_state', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'current_player', author$project$Main$playerDecoder),
	A2(
		elm$json$Json$Decode$field,
		'board',
		elm$json$Json$Decode$list(elm$json$Json$Decode$string)));
var author$project$Main$gameHost = 'http://localhost:4000/play/36093c34-d08b-11e8-a2c5-542696d2453b';
...
var author$project$Main$fetchGame = A2(
	elm$http$Http$send,
	author$project$Main$GameStateReceived,
	A2(elm$http$Http$get, author$project$Main$gameHost, author$project$Main$gameDecoder));
var author$project$Main$initialModel = {
	board: _List_Nil,
	current_player: A2(author$project$Main$Player, 'human', 'x'),
	game_state: 'playing',
	player_o: A2(author$project$Main$Player, 'human', 'o'),
	player_x: A2(author$project$Main$Player, 'human', 'x')
};
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(author$project$Main$initialModel, author$project$Main$fetchGame);
};
...
var author$project$Main$makeMove = function (move) {
	return A2(
		elm$http$Http$send,
		author$project$Main$GameStateReceived,
		A2(elm$http$Http$get, author$project$Main$gameHost + ('/move/' + move), author$project$Main$gameDecoder));
};
	...
	function (message, model) {
		switch (message.$) {
			case 'GameStateReceived':
				if (message.a.$ === 'Ok') {
					var gameState = message.a.a;
					return _Utils_Tuple2(gameState, elm$core$Platform$Cmd$none);
				} else {
					var err = message.a.a;
					var _n1 = A2(elm$core$Debug$log, 'error ', err);
			...
			case 'CellClicked':
				...
				return _Utils_Tuple2(
					model,
					author$project$Main$makeMove(cell));
			default:
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
		}
	});
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.Model":{"args":[],"type":"{ player_x : Main.Player, player_o : Main.Player, game_state : String.String, current_player : Main.Player, board : List.List String.String }"},"Main.Player":{"args":[],"type":"{ tipe : String.String, mark : String.String }"},"Http.Response":{"args":["body"],"type":"{ url : String.String, status : { code : Basics.Int, message : String.String }, headers : Dict.Dict String.String String.String, body : body }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"GameStateReceived":["Result.Result Http.Error Main.Model"],"CellClicked":["String.String"]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Http.Response String.String"],"BadPayload":["String.String","Http.Response String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));